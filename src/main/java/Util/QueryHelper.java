...
public class QueryHelper {
    ...
    public static CourseSection searchCourseSection(String courseCode) {
        init();
        Query query = em.createQuery("SELECT c FROM CourseSection c WHERE c.courseCode = :courseCode");
